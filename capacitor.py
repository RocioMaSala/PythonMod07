from ex1.factory_creation_creature_ex1 import HealingCreatureFactory, TransformCreatureFactory
...
if __name__ == "__main__":
    ...
    transform_factory_base.transform()
    transform_factory_base.attack()
    transform_factory_base.revert()
    ...
    transform_factory_evolved.transform()
    transform_factory_evolved.attack()
    transform_factory_evolved.revert()
